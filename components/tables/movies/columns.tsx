  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex justify-center">
        <Image width={100} height={100} src={row.original.poster_path} alt={row.original.title} className="h-16" />
      </div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex justify-center">
        <Image width={100} height={100} src={row.original.backdrop_path} alt={row.original.title} className="h-16" />
      </div>
    ),
  },
  {
