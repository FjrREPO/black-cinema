...
const AddMethodPayment = () => {
    ...
    const [nameCard, setNameCard] = useState<any>('');
    const [numberCard, setNumberCard] = useState<any>('');
    const [categoryInstitue, setCategoryInstitue] = useState<any>('');
    const [imageCard, setImageCard] = useState<any>('');
    ...
    const onSubmit: SubmitHandler<FieldValues> = async (data) => {
        ...
        try {
            ...
            await axios.post('/api/payment/method', formattedData);
            await Swal.fire({ icon: 'success', title: 'Success', text: 'Card added successfully!' });
