    ...
    return (
        ...
        >
            <div className="bg-white/20 dark:bg-black/50 pt-[90px] min-h-[100vh] flex justify-center items-center py-5">
                <div
                    className="flex flex-col backdrop-blur-lg border max-w-[90vw] md:max-w-[80vw] lg:max-w-[60vw] rounded-lg w-fit p-5 justify-center items-center"
                >
                    ...
                    <div className="block sm:flex sm:flex-row gap-5 ">
                        <div className="flex w-full sm:w-fit justify-center">
                            <Image width={500} height={500} src={movie.poster_path} alt={movie.title} className="flex w-[250px] rounded-lg" />
                        </div>
                                ...
                                <div className='flex flex-col'>
                                    {paymentCard.map((pay: any, index: number) => (
                                        <div className='flex flex-col pb-2 items-center' key={index}>
                                            <div
                                                className={`flex flex-row h-20 w-[70vw] lg:w-[40vw] justify-between rounded-tr-lg rounded-tl-lg ${index === checkedIndex ? 'bg-gray-200 dark:bg-gray-800' : 'bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-br-lg rounded-bl-lg cursor-pointer'}`}
